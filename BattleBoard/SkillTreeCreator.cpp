...
//=============================================================================
bool SkillTreeCreator::create_skill_tree()
//
...
//=============================================================================
int SkillTreeCreator::num_skills() const
//
...
//=============================================================================
SkillLinear* SkillTreeCreator::skill(int num)
//
//D Get the nth skill. 
//
//-----------------------------------------------------------------------------
...
//=============================================================================
bool SkillTreeCreator::skill_from_xml(tinyxml2::XMLElement* node)
//
...
//-----------------------------------------------------------------------------
{
  ...
  auto skill = std::make_unique<SkillLinear>(name, cost, max_picks, is_status);
